...
def fetch_poster(movie_id):#url from TMDB website
...
st.set_page_config(
    page_title="Movie Recommendation System",  # Change this to your desired title
    page_icon=":cinema:",   # You can also set a custom icon
...
def recommend(movie_title):
    ...
    for i in distance[1:6]:
        ...
        recommend_poster(fetch_poster(movies_id))
